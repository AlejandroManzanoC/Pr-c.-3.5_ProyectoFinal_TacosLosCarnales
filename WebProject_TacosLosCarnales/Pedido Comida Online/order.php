...
<?php include('partials-front/menu.php'); ?>
    ...
    <section class="food-search2">
        <div class="container">
            ...
            <h2 class="text-center text-white">Llena el cuestionario para confirmar tu orden.</h2>

            <form action="" method="POST" class="order">
                <fieldset>
                    <legend>Comida seleccionado</legend>
                ...
                <fieldset>
                    <legend>Detalles del Envío</legend>
                    ...
                    <div class="order-label">Número Teléfono</div>
