    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explora categorías de Comidas</h2>
    ...
    <section class="food-menu">
        <div class="container">
            <h2 class="text-center">Nuestro Menú de Comidas</h2>
                ...
                while($row=mysqli_fetch_assoc($res2))
                {
                    ...
                    <div class="food-menu-box">
                        ...
                        <div class="food-menu-desc">
                            ...
                            <a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="btn btn-primary">Ordena ya</a>
                        </div>
                    </div>
        ...
        <p class="text-center">
            <a href="#">Ver todas las comidas</a>
        </p>
    </section>
